...
const CourseFeatureExplanations = ({ content }: SectionData) => {
    return (
        <div className={`order-${content.order_idx}`}>
            ...
            <div className="mt-4 rounded-lg border border-gray-200 divide-y divide-gray-200 p-2.5 ">
                {
                    content.values.map((item) => (
                        <div key={item.id} className="flex items-start gap-3 p-2.5 justify-between">
